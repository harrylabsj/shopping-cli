...
`GET /merchants/{merchant_id}/private-config` returns the merchant's current `automation_boundaries` and version only to a matching merchant or scoped agent token.
