...
```text
docs/a2a/
  shopping-cli-a2a-binding-1.0.md
```
...
## 5.5 `agent_agent_profile_snapshots`
...
shopping-cli v1.1 设计**不把 `shopping.negotiation/0.1` 重命名成 KNP/1.0**，也不假装两者已等价。
...
12. 正式路径固定为 `docs/a2a/shopping-cli-a2a-binding-1.0.md`。
